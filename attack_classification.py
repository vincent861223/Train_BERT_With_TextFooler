...
class NLI_infer_BERT(nn.Module):
    def __init__(self,
        ...
        self.dataset = NLIDataset_BERT(token_dir, max_seq_length=max_seq_length, batch_size=batch_size)
...
def main():
    ...
    parser.add_argument("--target_token_path",
                        type=str,
    ...
    if args.target_model == 'wordLSTM':
        ...
        model = NLI_infer_BERT(args.target_model_path, args.target_token_path, nclasses=args.nclasses, max_seq_length=args.max_seq_length)
