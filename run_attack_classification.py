...
# for BERT target
command = 'python attack_classification.py --dataset_path train_bert.pkl ' \
          '--target_model bert ' \
          '--target_model_path results/imdb/ ' \
          '--max_seq_length 256 --batch_size 32 --output_dir results/imdb_result ' \
